...
/*!
  ...
  \brief A function to run ltlf2smv routine.
  ...
  The function 'ltlf2smv' will convert this formula to a SMV module, which is
...
#ifndef __NUSMV_CORE_LTL_LTLF2SMV_LTLF2SMV_H__
#define __NUSMV_CORE_LTL_LTLF2SMV_LTLF2SMV_H__
...
/*!
  \brief
*/
typedef struct Ltlf2SmvPrefixes_TAG
{
  char* pre_prefix;
  char* prefix_name;
...
/**MAcro********************************************************************
  ...
  of modules generated by ltlf2smv procedure]
...
*/
#define LTLF_MODULE_BASE_NAME "ltlf_spec_"
...
/*!
  ...
  \sa ltlf2smv_core
*/
node_ptr ltlf2smv(NuSMVEnv_ptr env,
...
*/
node_ptr ltlf2smv_single_justice(NuSMVEnv_ptr env,
                                       unsigned int uniqueId,
                                       node_ptr in_ltl_expr);

#endif /* __NUSMV_CORE_LTL_LTLF2SMV_LTLF2SMV_H__ */
