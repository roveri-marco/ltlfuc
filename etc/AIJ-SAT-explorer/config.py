...
LTLFUCBDDBENCHMARKSD="ltlfuc_bdd-done.txt"
LTLFUCBDDBENCHMARKSE="ltlfuc_bdd-error.txt"
LTLFUCSATBENCHMARKSD="ltlfuc_sat-done.txt"
LTLFUCSATBENCHMARKSE="ltlfuc_sat-error.txt"
